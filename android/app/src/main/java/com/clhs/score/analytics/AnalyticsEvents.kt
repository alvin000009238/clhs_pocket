...
object AnalyticsEvents {
    ...
    const val ANNOUNCEMENT_REMINDER_START = "announcement_reminder_start"
...
object AnalyticsValues {
    ...
    const val FEATURE_OVERVIEW = "overview"
    const val FEATURE_SCHEDULE = "schedule"
    const val FEATURE_GRADES = "grades"
    const val FEATURE_CAMPUS = "campus"
    ...
    const val SOURCE_NOTIFICATION_GENERAL = "notification_general"
    const val SOURCE_SETTINGS = "settings"
    const val SOURCE_WIDGET_SCHEDULE = "widget_schedule"
    const val SCREEN_CLASS_MAIN_ACTIVITY = "MainActivity"
...
object AnalyticsScreenNames {
    ...
    const val SCHEDULE_CUSTOMIZATIONS = "schedule_customizations"
    const val GRADES = "grades"
    const val SCORE_SIMULATOR = "score_simulator"
    const val SUBJECT_TREND = "subject_trend"
    const val CAMPUS = "campus"
    const val SCHOOL_CALENDAR = "school_calendar"
    const val SCHOOL_ANNOUNCEMENTS = "school_announcements"
    const val SCHOOL_ANNOUNCEMENT_DETAIL = "school_announcement_detail"
    const val ANNOUNCEMENT_REMINDER_SETTINGS = "announcement_reminder_settings"
    const val ANNOUNCEMENT_REMINDER_UNITS = "announcement_reminder_units"
    const val WORK_MANAGER_INFO = "work_manager_info"
    const val SCHOOL_WEBSITE = "school_website"
    ...
    const val ONBOARDING_APPEARANCE = "onboarding_appearance"
    const val ONBOARDING_PERMISSIONS = "onboarding_permissions"
    const val ONBOARDING_ACCOUNT = "onboarding_account"
    const val WEB_VIEW_LOGIN = "web_view_login"
}
